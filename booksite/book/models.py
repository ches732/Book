...
class Author(models.Model):
    ...
    middle_name = models.CharField(max_length=50, blank=False, null=True, default=None, verbose_name='Отчество')
    date_of_birth = models.DateField(null=True, blank=True, verbose_name='Дата рождения')
    date_of_death = models.DateField(null=True, blank=False, verbose_name='Дата смерти')
